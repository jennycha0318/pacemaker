...
export function GoogleButton() {
  ...
  return (
    <button onClick={google} type="button"
      className="flex w-full items-center justify-center gap-2.5 rounded-2xl border-[1.5px] border-line bg-white py-3 text-[15px] font-bold text-[#3c4043] hover:bg-[#faf7f9]">
