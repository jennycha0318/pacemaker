...
function safetyDiagnosis(): Diagnosis {
  return {
    ...
    score: 8,
    factors: [],
    reason: `무섭게 했던 사람을 그래도 다시 붙잡고 싶은 마음, 그건 당신이 약하거나 어리석어서가 아니에요. 좋았던 순간과 무서웠던 순간이 같은 한 사람 안에 들어 있으니까, 마음이 두 갈래로 찢어지는 게 당연해요. 그 사람이 그럴 만큼 힘든 시기였을 거라고, 시간이 지나면 달라질 거라고 믿고 싶은 마음도 이해해요.
그런데요. 통제하고 위협하고 손을 대는 건, 사랑이 서툴러서 나오는 방식이 아니에요. 당신이 더 잘 맞춰주거나 더 사랑해줘서 고쳐질 수 있는 문제도 아니고요. 그건 온전히 그 사람의 몫이고, 당신이 떠안아야 할 짐이 아니었어요.
그래도 다시 다가가고 싶은 날이 올 거예요. 그 마음을 억지로 지우라는 게 아니에요. 다만 다시 손을 뻗기 전에, 딱 한 번만 '그 사람에게 한 번 더 기회를'이 아니라 '오늘 밤 내가 안전한가, 내 일상이 무사한가'의 자리에서 다시 생각해봐 줄래요.
그리고 혹시 마음이 흔들리거나 무서운 순간이 오면, 혼자 견디지 않아도 돼요. 여성긴급전화 1366은 24시간 당신 편에서 이야기를 들어주고, 위험이 코앞이라 느껴지면 112가 있어요. 이건 당신을 다그치는 벽이 아니라, 언제든 손 내밀 수 있게 곁에 둔 비상구예요.`,
    actions: [
    ...
    selfMessage: "무서운 일을 겪고도 그 사람을 미워하지 못하는 내가 이상한 게 아니야. 좋았던 기억이 있으니까 헷갈리는 거고, 그건 내 마음이 따뜻하다는 증거이기도 해. 다만 오늘은, 누구보다 먼저 지켜야 할 사람이 나라는 걸 잊지 않기로 하자.",
    plan: {
